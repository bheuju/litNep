...
public class PhotoMultipartRequest<T> extends Request<T> {
	...
	private static final String FILE_PART_NAME = "uploaded_file";
	...
	public PhotoMultipartRequest(String url, Listener<T> listener,
			ErrorListener errorListener, File imageFile) {
